...
export const goldStar = {
  path:
    'M 0.000 -3.000 L 14.695 5.225 L 11.413 -11.292 L 23.776 -22.725 L 7.053 -24.708 L 0.000 -40.000 L -7.053 -24.708 L -23.776 -22.725 L -11.413 -11.292 L -14.695 5.225 L 0.000 -3.000',
  fillColor: 'gold',
  fillOpacity: 1,
  scale: 1,
  strokeColor: 'gold',
